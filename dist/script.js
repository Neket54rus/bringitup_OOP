...
/* harmony import */ var _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/slider/slider-min */ "./src/js/modules/slider/slider-min.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var slider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
    btnsSelector: '.next',
    wrapperForSliderSelector: '.page'
  });
  slider.render();
  var modulePageSlider = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_1__["default"]({
    wrapperForSliderSelector: '.moduleapp',
    btnsSelector: '.next'
  });
  modulePageSlider.render();
  var showUpSlider = new _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  showUpSlider.init();
  var modulesSlider = new _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_2__["default"]({
  ...
  modulesSlider.init();
  var feedSlider = new _modules_slider_slider_min__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTrigger",
    value: function bindTrigger(container, items, counter) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "initMasc",
    value: function initMasc() {
      var setCursorPos = function setCursorPos(pos, elem) {
        elem.focus(); // elem.setSelectionRange(pos, pos)
...
/*#__PURE__*/
function () {
  function VideoPlayer(triggerSelector, modalWindowSelector) {
...
function (_Slider) {
  ...
  function MiniSlider(wrapper, next, prev, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, wrapper, next, prev, activeClass, animate, autoplay));
  }
      ...
      this.prev.addEventListener('click', function () {
        for (var i = _this2.slides.length - 1; i > 0; i--) {
          if (_this2.slides[i].tagName !== 'BUTTON') {
            ...
            _this2.wrapper.insertBefore(active, _this2.slides[0]);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      _ref$wrapperForSlider = _ref.wrapperForSliderSelector,
      wrapperForSliderSelector = _ref$wrapperForSlider === void 0 ? null : _ref$wrapperForSlider,
      _ref$btnsSelector = _ref.btnsSelector,
      btnsSelector = _ref$btnsSelector === void 0 ? null : _ref$btnsSelector,
      _ref$nextBtnSelector = _ref.nextBtnSelector,
      nextBtnSelector = _ref$nextBtnSelector === void 0 ? null : _ref$nextBtnSelector,
      _ref$prevBtnSelector = _ref.prevBtnSelector,
      prevBtnSelector = _ref$prevBtnSelector === void 0 ? null : _ref$prevBtnSelector,
